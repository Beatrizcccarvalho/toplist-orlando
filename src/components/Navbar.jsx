        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 flex items-center">
              <img className="h-12 w-auto" src="/TopListLogo3.png" alt="Toplist Orlando" />
            </Link>
          </div>
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            {location.pathname === '/' ? (
              ...
              <>
                ...
                <Link
                  to="/resorts"
                  className={`block px-3 py-2 rounded-md text-base font-medium ${isActive('/resorts') ? 'bg-blue-100 text-blue-600' : 'text-gray-700 hover:bg-gray-100'}`}
                  onClick={() => setIsOpen(false)}
                >
                  Resorts
                </Link>
